...
prompt_parts_todo = [
  ...
  "output: In around 1-3 bullet points, give a short to-do list on what the user should do based on what the email is saying. Make it short so it can be copied and pasted for later, but also include important dates and times. Use language that is like a to-do: Don't use language determiners and don't use personal pronouns (like \"you\"). Also put a '\n\n' between each bullet point.",
