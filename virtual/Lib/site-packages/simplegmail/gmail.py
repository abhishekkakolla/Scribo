...
class Gmail(object):
    ...
    # --Abhishek: altered the path where gmail_token.json is created to %localappdata%
    # to prevent admin privilege error (since program is installed in C:\Program Files)
    gmailtokenpath = os.getenv('LOCALAPPDATA') + r"\Scribo\gmail_token.json"
    def __init__(
        self,
        client_secret_file: str = 'client_secret.json',
        creds_file: str = gmailtokenpath,
